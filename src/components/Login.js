...
const handleClick=async(e)=>{
  ...
  const response = await fetch(`${process.env.REACT_APP_BASE_URI}/login`,{
      ...
      return (
        ...
        <div style={{paddingRight:"120px",marginTop:"90px",marginLeft:"50px"}}>

        <h1 className='d-flex justify-content-center' style={{marginLeft:"200px",marginTop:"90px"}}>Login on WorkLab</h1>
  ...
  <form className="form" method="post">
   ...
   <Link to={"/verifyLogin"}>Already a members?</Link>
    </div>
    <button className="button-submit" onClick={handleClick} type="submit">
      Sign In
    </button>
    <p className="p">
    ...
    <div className="flex-row">
      <button className="btn google" onClick={(e) => loginWithRedirect()}>
        <svg
          xmlSpace="preserve"
